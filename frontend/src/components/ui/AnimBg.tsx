...
export default function AnimBg() {
  ...
  useEffect(() => {
    ...
    const orbs = [
      { x: 0.15, y: 0.2,  r: 520, color: '59,130,246', a: 0.06, vx: 0.06,  vy: 0.04  },
      { x: 0.8,  y: 0.75, r: 480, color: '59,130,246', a: 0.05, vx: -0.05, vy: -0.05 },
      { x: 0.5,  y: 0.5,  r: 400, color: '59,130,246', a: 0.04, vx: 0.03,  vy: -0.04 },
